...
import { sendHiringRequestController, handleHiringRequestController, hiringListController, } from '../controllers/hirings/index.js';
// Inicializamos el router.
export const router = express.Router();
// Enviar solicitud de contratación.
router.post('/api/players/:playerId/hirings', authUserMiddleware, sendHiringRequestController);
// Finalizar solicitud de contratación.
router.put('/api/players/:playerId/hirings/:hiringId', authUserMiddleware, canEditPlayer, handleHiringRequestController);
